...
public class AlgoImpl
{
    ...
    private void update(Matrices path, Matrices distance, Matrices potent, int n)
    {
        ...
        {
            for (int col = row+1; col < path. size; col++)
            {
    ...
    {
        int[] eccentricity = new int[distance. size];
        ...
        if (numComponents == 1)
        {
            ...
            {
                int maxValue = -1;
                for (int col = 0; col < distance. size; col++)
                {
    ...
    public void calcBridges(Matrices adja, int numComponents, AlgoImpl bergerResult)
    {
        ...
        for (int row = 0; row < adja. size; row++)
        {
            for (int col = row+1; col < adja. size; col++)
            {
    ...
    public void calcArticulations(Matrices adja, int numComponents, AlgoImpl bergerResult)
    {
        ...
        for (int row = 0; row < adja. size; row++)
        {
            ...
            int[] saveRow = new int[adja. size];

            for (int col = 0; col < adja. size; col++)
            {
